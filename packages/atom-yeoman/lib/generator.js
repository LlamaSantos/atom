...
var Generator = (function () {
    ...
    Generator.prototype.selectPath = function () {
        var _this = this;
        Generator.getPath(this.path, this.options).then(function (path) { return _this.listGenerators(path); }).then(function (generators) { return _this.selectGenerator(generators); });
    };
    ...
    Generator.prototype.run = function (generator, path) {
        ...
        this.listGenerators(path).then(function (generators) {
            loophole.allowUnsafeNewFunction(function () {
                process.chdir(path);
                try {
