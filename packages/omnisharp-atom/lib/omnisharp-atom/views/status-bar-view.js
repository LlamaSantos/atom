...
var StatusBarComponent = (function (_super) {
    ...
    StatusBarComponent.prototype.componentWillMount = function () {
        ...
        this.disposable.add(code_check_1.codeCheck.observe.diagnostics.subscribe(function (diagnostics) {
        ...
        this.disposable.add(world_1.world.observe.updates
            .buffer(world_1.world.observe.updates.throttle(100), function () { return rx_1.Observable.timer(100); })
