...
var GoToDefinition = (function () {
    ...
    GoToDefinition.prototype.activate = function () {
        ...
        this.disposable.add(Omni.switchActiveEditor(function (editor, cd) {
            ...
            var eventDisposable;
            cd.add(atom.config.observe('omnisharp-atom.highlight', function (enabled) {
    ...
    GoToDefinition.prototype.goToDefinition = function () {
        ...
        if (editor) {
            ...
            Omni.request(editor, function (client) { return client.gotodefinition(client.makeDataRequest({
