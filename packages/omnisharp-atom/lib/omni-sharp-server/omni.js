...
var Omni = (function () {
    function Omni() {
        ...
        this._activeEditor = this._activeEditorSubject.asObservable().delay(50).shareReplay(1);
        this._activeConfigEditorSubject = new rx_1.BehaviorSubject(null);
        this._activeConfigEditor = this._activeConfigEditorSubject.asObservable().delay(50).shareReplay(1);
    ...
    Omni.prototype.whenEditorConnected = function (editor) {
        return manager.getClientForEditor(editor)
            .flatMap(function (solution) { return solution.state.startWith(solution.currentState); })
