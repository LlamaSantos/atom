...
var ClientV1 = (function (_super) {
    ...
    ClientV1.prototype.metadata = function (request, options) {
        chai_1.assert.isNotNull(request.AssemblyName);
        chai_1.assert.isNotNull(request.TypeName);
    ...
    ClientV1.prototype.packagesearch = function (request, options) {
        chai_1.assert.isNotNull(request.ProjectPath, 'request.ProjectPath must not be null');
        chai_1.assert.isNotNull(request.Search, 'request.Search must not be null');
    ...
    ClientV1.prototype.packageversion = function (request, options) {
        chai_1.assert.isNotNull(request.ProjectPath, 'request.ProjectPath must not be null');
        chai_1.assert.isNotNull(request.Id, 'request.Id must not be null');
