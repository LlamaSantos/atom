...
describe("Project Finder", function () {
    it('should support files existing in the same folder', function () {
        var cs = project_finder_1.findProject(path_1.join(__dirname, 'fixture/project-finder/same-folder/cs'), console);
        chai_1.expect(cs).to.not.be.null;
        chai_1.expect(cs).to.be.eql(path_1.join(__dirname, 'fixture/project-finder/same-folder/cs'));
        var cs = project_finder_1.findProject(path_1.join(__dirname, 'fixture/project-finder/same-folder/cs/'), console);
        chai_1.expect(cs).to.not.be.null;
        chai_1.expect(cs).to.be.eql(path_1.join(__dirname, 'fixture/project-finder/same-folder/cs'));
        ...
        chai_1.expect(solution).to.be.eql(path_1.join(__dirname, 'fixture/project-finder/same-folder/solution/something.sln'));
        var solution = project_finder_1.findProject(path_1.join(__dirname, 'fixture/project-finder/same-folder/solution/'), console);
        chai_1.expect(solution).to.not.be.null;
        chai_1.expect(solution).to.be.eql(path_1.join(__dirname, 'fixture/project-finder/same-folder/solution/something.sln'));
    });
    it('should find projects up the folder heirarchy if not found', function () {
        ...
        chai_1.expect(solution).to.not.be.null;
        chai_1.expect(solution).to.be.eql(path_1.join(__dirname, 'fixture/project-finder/global-root-folder/solution/something.sln'));
        ...
        chai_1.expect(solution).to.not.be.null;
        chai_1.expect(solution).to.be.eql(path_1.join(__dirname, 'fixture/project-finder/csx-root-folder/solution/something.sln'));
        var csproj = project_finder_1.findProject(path_1.join(__dirname, 'fixture/project-finder/solution-root-folder'), console);
        chai_1.expect(csproj).to.not.be.null;
        chai_1.expect(csproj).to.be.eql(path_1.join(__dirname, 'fixture/project-finder/solution-root-folder/something.sln'));
        ...
        chai_1.expect(project).to.not.be.null;
        chai_1.expect(project).to.be.eql(path_1.join(__dirname, 'fixture/project-finder/solution-root-folder/something.sln'));
        ...
        chai_1.expect(solution).to.not.be.null;
        chai_1.expect(solution).to.be.eql(path_1.join(__dirname, 'fixture/project-finder/solution-root-folder/solution/something.sln'));
        var csproj = project_finder_1.findProject(path_1.join(__dirname, 'fixture/project-finder/no-solution'), console);
        chai_1.expect(csproj).to.not.be.null;
        chai_1.expect(csproj).to.be.eql(path_1.join(__dirname, 'fixture/project-finder/no-solution'));
    });
});
